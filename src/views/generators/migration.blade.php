...
class EntrustSetupTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('{{ $user_roles_table }}', function ($table) {
            $table->increments('id')->unsigned();
    ...
    {
        Schema::table('{{ $user_roles_table }}', function (Blueprint $table) {
            $table->dropForeign('{{ $user_roles_table }}_user_id_foreign');
            $table->dropForeign('{{ $user_roles_table }}_role_id_foreign');
        });
